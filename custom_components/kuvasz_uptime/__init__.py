...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    coordinator = KuvaszCoordinator(hass, client, scan_interval, selected_monitors, stats_period)
...
def _remove_stale_devices(hass: HomeAssistant, entry: ConfigEntry, active_monitors: list) -> None:
